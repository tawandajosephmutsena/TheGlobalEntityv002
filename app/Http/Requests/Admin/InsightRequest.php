...
class InsightRequest extends SecureFormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'content.introduction' => [...$this->getRichTextRules(2000000, false), new SafeHtml()],
            'content.body' => [...$this->getRichTextRules(2000000, false), new SafeHtml()],
            'content.conclusion' => [...$this->getRichTextRules(2000000, false), new SafeHtml()],
            ...
            'content.sections.*.content' => ['required_with:content.sections', ...$this->getRichTextRules(2000000), new SafeHtml()],
