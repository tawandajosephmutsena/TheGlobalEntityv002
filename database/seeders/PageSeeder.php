    ...
    public function run(): void
    {
        $pages = [
                    ...
                    'blocks' => [
                        ...
                        [
                            ...
                            'content' => [
                                ...
                                'body' => "Founded in 2019, Ottomate emerged from a singular conviction: that the digital world deserved more than \"good enough.\" We saw a landscape cluttered with templates and decided to build a sanctuary for custom, high-end digital craft.\n\nWhat started as a boutique design studio has evolved into a full-scale digital innovation house. We don't just build websites; we build competitive advantages for brands that dare to lead.",
                                'stats' => [
            ...
            [
                'title' => 'Services',
                'slug' => 'services',
                'meta_title' => 'Our Services - Ottomate',
                    ...
                    'blocks' => [
                        ...
                        [
                            ...
                            'content' => [
                                ...
                                'subtitle' => 'Inquiries',
                                'items' => [
                                    ['label' => 'Email', 'value' => 'hello@ottomate.com', 'href' => 'mailto:hello@ottomate.com'],
                ...
                'content' => [
                    'blocks' => [
                        [
                            ...
                            'type' => 'text',
                            'content' => [
                                'body' => "# Terms of Service\n\nBy accessing this website we assume you accept these terms and conditions. Do not continue to use Ottomate CMS if you do not agree to take all of the terms and conditions stated on this page."
                            ]
                        ]
                    ]
                ]
