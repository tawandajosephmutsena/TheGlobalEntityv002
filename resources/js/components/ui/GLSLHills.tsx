...
// Plane class moved outside to comply with react-compiler rules
class Plane {
      ...
      new THREE.RawShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main(void) {
            ...
            float opacity = clamp((180.0 - dist) / 180.0, 0.0, 1.0) * 0.8;
            
            // Subtle hills color - using a more visible light grey by default
            vec3 color = vec3(0.75, 0.75, 0.82); 
...
const GLSLHills = ({ 
  ...
  useEffect(() => {
    ...
    const init = () => {
      console.log('GLSLHills: Initializing...', {
    ...
    return () => {
      console.log('GLSLHills: Unmounting...');
  ...
  return (
    <div ref={containerRef} className={className} style={{ position: 'absolute', inset: 0, width, height, pointerEvents: 'none' }}> 
      <canvas
        ref={canvasRef}
        style={{
          width: '100%',
