        ...
        >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                ...
                <motion.a 
                    ...
                    className="inline-flex items-center gap-3 text-white font-black text-xs tracking-widest group/btn bg-primary/20 backdrop-blur-md px-6 py-3 rounded-full border border-white/20 hover:bg-primary transition-all duration-500"
                >
                    Chart Path 
