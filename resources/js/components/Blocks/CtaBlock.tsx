    ...
    return (
        <section className="bg-white dark:bg-[#0a0a0a] py-40 relative overflow-hidden border-t">
            <div className="mx-auto max-w-7xl px-4 flex flex-col items-center text-center relative z-10">
                <span className="text-agency-accent font-black tracking-tighter text-xs mb-8 block">{subtitle}</span>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-8">
                    ...
                    <div className="text-left">
                        <p className="text-agency-primary/60 dark:text-white/60 mb-2 font-mono tracking-tighter text-xs">Email us at</p>
