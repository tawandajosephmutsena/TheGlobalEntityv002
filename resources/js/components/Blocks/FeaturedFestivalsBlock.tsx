                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    <div>
                        <motion.h2 
                            ...
                            viewport={{ once: true }}
                            className="text-4xl md:text-5xl font-display font-black text-foreground mb-4 tracking-tighter"
                        >
                            {title}
                        </motion.h2>
                        <motion.p 
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="absolute top-4 left-4 right-4 flex justify-between items-start z-10">
                                        <Badge className="bg-primary/20 hover:bg-primary/30 text-primary backdrop-blur-md border border-primary/20 px-2.5 py-0.5 rounded-full text-[9px] font-black tracking-widest">
                                            {festival.category}
                                        </Badge>
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 p-5 pt-12 bg-gradient-to-t from-background to-transparent">
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <span className="text-[9px] font-black tracking-widest text-primary/80">{festival.author.name}</span>
                                        </div>
                                        <h3 className="text-xl font-display font-black text-foreground mb-2 line-clamp-1 group-hover:text-primary transition-colors leading-tight tracking-tighter">
                                            {festival.title}
                                        </h3>
                                        ...
                                        <div className="flex flex-wrap gap-1.5 mb-5 overflow-hidden h-5">
                                            {festival.activities.slice(0, 2).map((activity, idx) => (
                                                <span key={idx} className="text-[9px] font-black tracking-wide text-muted-foreground bg-secondary/10 border border-border/10 px-1.5 py-0.5 rounded">
                                                    {activity}
                                                </span>
                                            ))}
                                        ...
                                        <Button className="w-full h-10 rounded-lg bg-primary hover:bg-primary/90 text-white text-[11px] font-black tracking-widest transition-all shadow-lg shadow-primary/10 border-none">
