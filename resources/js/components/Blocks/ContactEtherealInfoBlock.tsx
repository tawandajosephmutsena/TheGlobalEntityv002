            ...
            >
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <Link 
                            ...
                            className="inline-flex items-center gap-4 font-serif font-bold text-primary uppercase text-sm tracking-[0.2em] border-b-2 border-primary/20 hover:border-primary transition-all"
                        >
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h4 className="font-serif font-bold text-3xl mt-4 uppercase tracking-tighter">{directPort.title}</h4>
                    </div>
                ...
                >
                    ...
                    <h5 className="font-serif font-bold text-secondary-foreground text-2xl uppercase tracking-widest leading-tight">{instantMagic.title}</h5>
                </motion.div>
                ...
                >
                    ...
                    <div>
                        <h4 className="font-serif font-bold text-3xl text-foreground uppercase tracking-tight">{voiceFrequency.title}</h4>
                ...
                >
                    ...
                    <div className="relative z-10">
                        <h4 className="font-serif font-bold text-xl uppercase text-muted-foreground tracking-[0.4em] mb-8">{socialTether.title}</h4>
