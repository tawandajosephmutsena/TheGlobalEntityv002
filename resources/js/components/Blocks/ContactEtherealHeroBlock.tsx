                    ...
                    <div className="lg:col-span-7 space-y-12">
                        ...
                        <div className="relative">
                            <motion.h1 
                                ...
                                viewport={{ once: true }}
                                className="font-display text-6xl md:text-8xl lg:text-9xl font-black text-foreground leading-tight tracking-tighter"
                            >
                                {titleLine1} <br/>
                    ...
                    <div className="lg:col-span-5 relative">
                        ...
                        >
                            ...
                            <form action="#" className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                                ...
                                <div className="pt-6">
                                    <Button className="w-full py-8 bg-primary hover:bg-primary/90 text-primary-foreground font-serif font-black text-lg tracking-[0.2em] transition-all shadow-xl rounded-none">
                                        {formSubmitText}
                                    </Button>
                                </div>
