            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                {(title || subtitle) && (
                    <div className="mb-24 text-center">
                        {subtitle && (
                            <span className="text-agency-accent font-black tracking-tighter text-xs mb-8 block">
                                {subtitle}
                            </span>
                        )}
                        {title && (
                            <h2 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.85] text-agency-primary dark:text-white">
                                {title.split(' ')[0]} <br/>
                            ...
                            <Link href={item.link} className="block relative h-full flex flex-col">
                                <div className="relative aspect-[16/10] rounded-[40px] overflow-hidden mb-8 shadow-2xl bg-agency-primary/5 dark:bg-white/5">
                                    ...
                                    <div className="absolute top-6 left-6 z-10">
                                        <span className="px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-[10px] font-black tracking-tighter shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-500 transform -translate-y-2 group-hover:translate-y-0">
                                            {item.category}
                                        </span>
                                    </div>
                                ...
                                <div className="px-2 flex-grow">
                                    <div className="flex items-center gap-6 mb-6 opacity-40 text-[10px] font-black tracking-tighter group-hover:opacity-100 transition-opacity duration-500">
                                    ...
                                    <h2 className={cn(
                                        'font-black tracking-tighter text-agency-primary dark:text-white mb-6 group-hover:text-agency-accent transition-colors duration-500',
