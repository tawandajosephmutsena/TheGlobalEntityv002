        ...
        <section className="theme-stitch bg-gradient-to-b from-surface-container-low to-surface py-32 px-8 text-on-surface">
            <div className="max-w-4xl mx-auto text-center">
                <motion.h2 
                    ...
                    viewport={{ once: true }}
                    className="font-display font-black text-5xl md:text-8xl mb-20 tracking-tighter leading-[0.85] [font-variant-caps:small-caps] lowercase"
                >
                    {title.includes('You?') ? (
                        <>Who Are <span className="text-secondary italic font-black [font-variant-caps:small-caps] lowercase">you?</span></>
                    ) : title}
                </motion.h2>
