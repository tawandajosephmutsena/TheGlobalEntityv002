    ...
    const contentInside = (
        <div className="asymmetric-grid items-center grid grid-cols-12 gap-y-12">
            <div className="col-span-12 lg:col-span-7 relative z-10 lg:pr-12 py-12">
                <span className="inline-block py-1 px-4 bg-secondary-container text-on-secondary-container rounded-full text-[10px] font-black tracking-widest mb-6 shadow-sm">
                    {highlight}
                </span>
                ...
                {featuredPost && (
                    <div className="flex items-center gap-4 group/author">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-on-surface-variant tracking-widest font-medium">
