...
const PartnersHero: React.FC<PartnersHeroProps> = ({
    ...
    return (
        <section 
            ref={containerRef}
            className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-agency-secondary py-32"
        >
            {/* Watercolor Background Effect */}
            <div className="absolute inset-0 z-0 watercolor-bg pointer-events-none">
                <div className="absolute top-[-15%] left-[-10%] w-[70%] h-[70%] rounded-full bg-agency-accent/10 blur-[140px] mix-blend-multiply dark:mix-blend-soft-light opacity-60" />
                <div className="absolute bottom-[-10%] right-[-15%] w-[60%] h-[60%] rounded-full bg-agency-accent/15 blur-[120px] mix-blend-multiply dark:mix-blend-soft-light opacity-50" />
                <div className="absolute top-[30%] left-[40%] w-[40%] h-[40%] rounded-full bg-agency-primary/5 blur-[100px] mix-blend-overlay opacity-30" />
            </div>
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden select-none z-[2]">
                <div className="absolute top-[15%] left-[10%] opacity-20 dark:opacity-40">
                    <Wind ref={floatRef1} className="text-agency-accent w-20 h-20 -rotate-12" />
                </div>
                <div className="absolute bottom-[20%] left-[8%] opacity-20 dark:opacity-40">
                    <Anchor ref={floatRef2} className="text-agency-accent w-28 h-28 rotate-12" />
                </div>
                <div className="absolute top-[25%] right-[10%] opacity-20 dark:opacity-40">
                    <Compass ref={floatRef3} className="text-agency-accent w-24 h-24 rotate-45" />
                </div>
            </div>
                ...
                <div className="max-w-5xl mx-auto text-center">
                    <AnimatedSection animation="fade-up" delay={100}>
                        <div className="flex justify-center mb-8">
                            <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-agency-accent/30 bg-agency-accent/5 text-agency-accent text-xs font-bold uppercase tracking-[0.2em] backdrop-blur-sm">
                    ...
                    <AnimatedSection animation="fade-up" delay={300} textReveal textRevealType="words">
                        <h1 className="text-6xl md:text-8xl lg:text-9xl font-black uppercase tracking-tighter text-agency-primary leading-[0.85] italic-not-really">
                            {title}
                        </h1>
                    </AnimatedSection>

                    <AnimatedSection animation="fade-up" delay={600} className="mt-10">
                        <p className="text-xl md:text-2xl text-agency-primary/70 max-w-3xl mx-auto leading-relaxed font-serif italic">
                            {description}
                        </p>
                    </AnimatedSection>
                    ...
                    <AnimatedSection animation="fade-up" delay={900} className="mt-16 flex flex-col sm:flex-row gap-6 justify-center items-center">
                        <Button 
                            size="lg" 
                            className="rounded-full px-10 h-16 text-base font-black uppercase tracking-widest bg-agency-primary text-agency-secondary hover:scale-105 transition-transform duration-500 group relative overflow-hidden" 
                            asChild
                        >
                            <a href={cta1.href}>
                        ...
                        <Button 
                            variant="outline" 
                            size="lg" 
                            className="rounded-full px-10 h-16 text-base font-black uppercase tracking-widest border-agency-primary/20 bg-transparent hover:bg-agency-primary/5 hover:border-agency-primary transition-all duration-500" 
                            asChild
                        >
                            <a href={cta2.href}>
                                {cta2.text}
            ...
            <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-agency-secondary to-transparent z-[5]" />
        </section>
    );
};
