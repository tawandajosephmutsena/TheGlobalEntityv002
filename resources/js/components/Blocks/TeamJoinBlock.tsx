        ...
        <section className="bg-agency-primary dark:bg-black py-40 relative">
            <div className="mx-auto max-w-5xl px-4 text-center">
                <AnimatedSection animation="scale">
                    ...
                    <a href={ctaHref} className="inline-flex h-20 px-12 items-center justify-center rounded-full bg-agency-secondary dark:bg-white text-agency-primary font-black text-lg tracking-widest hover:bg-agency-accent transition-all shadow-2xl">
                        {ctaText}
                    </a>
                </AnimatedSection>
            </div>
